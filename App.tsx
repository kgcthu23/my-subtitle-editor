...
const DopamineDispenser: React.FC = () => {
    ...
    const fetchDopamine = async (isFirstOpen: boolean = false, userClickCount: number = 0) => {
        ...
        try {
            ...
            // Priority for first 10 random standard fetches
            ...
            // Fallback to cat/dog/random if quota met or GitHub fails
    ...
    const handleOpen = () => {
        setIsOpen(true);
        setClickCount(0);
        setRandomImageSessionCount(0); // Reset random count on open
