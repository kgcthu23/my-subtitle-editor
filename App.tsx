...
const MOTIVATIONAL_QUOTES = [
    ...
    "သုသုက ထူးချွန်ပြီးသားပဲဟာ... ယုံကြည်မှုသာ ရှိပါစေ။",
    ...
    "စိတ်ဖိစီးမှုတွေကို မေ့ထားလိုက်တော့။ သုသု အကောင်းဆုံး လုပ်ခဲ့ပြီးပြီပဲ။",
    ...
    "သုသုရေ... အောင်ပွဲခံဖို့ ပြင်ထားလိုက်တော့။",
    "သုသုက No.1 ပဲ။",
