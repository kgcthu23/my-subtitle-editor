...
const MOTIVATIONAL_QUOTES = [
    ...
    "I’m sending all the luck in the world to you, Thu Thu. You deserve every bit of it.",
    "Never forget that I’m always on your side, Thu Thu.",
    "I hope everything goes as smoothly as possible for you today.",
    "Stay calm and keep that focus, Thu Thu... you’ve got this handled.",
    ...
    "ဒီစာမေးပွဲက သုသုအတွက်တော့ အေးဆေးပါ။",
    ...
    "စိတ်ဖိစီးမှုတွေကို မေ့ထားခဏ။ သုသု အကောင်းဆုံး ကြိုးစားထားတာပဲ။",
    ...
    "သုသုက No.1 ပဲ။",
    "သုသု အတွက် စီစီ့ရဲ့ အားအင်တွေ ပို့ပေးလိုက်တယ်။",
    "သုသု ဖြေသမျှ အမှန်တွေချည်း ဖြစ်ပါစေ။",
    "ယုံကြည်မှုသာ ထား၊ သုသု နိုင်ကို နိုင်ရမယ်။",
    "သုသု ရေ... လုပ်ပြလိုက်စမ်းပါ။",
    "ချစ်ရတဲ့ သုသု... Good Luck ပါနော်。"
];
